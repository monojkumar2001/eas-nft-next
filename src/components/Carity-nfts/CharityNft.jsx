      ...
      <div className="my-nfts-wrapper my-collection-page">
        <div className="container">
            <div className="nft-header-content text-center">
                <h4 className="sub-title">DONATE TODAY</h4>
                <h1 className="section-title nft-header-title charity-nft-title">Every Little Bit Helps</h1>
            </div>
